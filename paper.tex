...
In this section, we will walk through the end-to-end workflow of \rhyme, demonstrating how the \rhyme query get compiled and generate efficient code to execute the query. Figure \ref{workflow} demonstrates the pipeline of \rhyme compiler.\par
\begin{figure}[H]
  \centering
